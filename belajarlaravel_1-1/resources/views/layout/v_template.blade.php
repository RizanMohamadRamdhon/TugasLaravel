            ...
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  <img src="{{asset('template')}}/dist/img/a.jpg" class="user-image" alt="User Image">
                  <span class="hidden-xs">Mohamad Rizan Ramdhon</span>
                </a>
                <ul class="dropdown-menu">
                  <!-- User image -->
                  <li class="user-header">
                    <img src="{{asset('template')}}/dist/img/a.jpg" class="img-circle" alt="User Image">
                    <p>
                      Mohamad Rizan Ramdhon - Web Developer
        ...
        <section class="sidebar">
          ...
          <div class="user-panel">
            <div class="pull-left image">
              <img src="{{asset('template')}}/dist/a.jpg" class="img-circle" alt="User Image">
            </div>
            <div class="pull-left info">
              <p>Mohamad Rizan Ramdhon</p>
